...
public class AndroidPlatformSupport extends PlatformSupport {
  ...
  public void updateDisplaySize() {
    if (SPDSettings.landscape() != null) {
      AndroidGame.instance.setRequestedOrientation(
          SPDSettings.landscape()
  ...
  public boolean connectedToUnmeteredNetwork() {
    ...
    ConnectivityManager cm =
        (ConnectivityManager) AndroidGame.instance.getSystemService(Context.CONNECTIVITY_SERVICE);
  ...
  public void setupFontGenerators(int pageSize, boolean systemfont) {
    ...
    basicFontGenerator =
        KRFontGenerator =
            SCFontGenerator = TCFontGenerator = JPFontGenerator = fallbackFontGenerator = null;

    if (Gdx.files.absolute("/system/fonts/Roboto-Regular.ttf").exists()) {
      basicFontGenerator =
          new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/Roboto-Regular.ttf"));
    } else if (Gdx.files.absolute("/system/fonts/DroidSans.ttf").exists()) {
      basicFontGenerator =
          new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/DroidSans.ttf"));
    }
    if (!systemfont) {
      if (basicFontGenerator == null) {
        basicFontGenerator =
            fallbackFontGenerator =
    ...
    if (Gdx.files.absolute("/system/fonts/NotoSansCJK-Regular.ttc").exists()) {
              ...
              TCFontGenerator =
                  JPFontGenerator =
                      new FreeTypeFontGenerator(
                          Gdx.files.absolute("/system/fonts/NotoSansCJK-Regular.ttc"), typeFace);
      ...
      if (Gdx.files.absolute("/system/fonts/NanumGothic.ttf").exists()) {
        KRFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NanumGothic.ttf"));
      } else if (Gdx.files.absolute("/system/fonts/NotoSansKR-Regular.otf").exists()) {
        KRFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansKR-Regular.otf"));
      ...
      if (Gdx.files.absolute("/system/fonts/NotoSansSC-Regular.otf").exists()) {
        SCFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansSC-Regular.otf"));
      } else if (Gdx.files.absolute("/system/fonts/NotoSansHans-Regular.otf").exists()) {
        SCFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansHans-Regular.otf"));
      }

      // Traditional Chinese font generators
      if (Gdx.files.absolute("/system/fonts/NotoSansTC-Regular.otf").exists()) {
        TCFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansTC-Regular.otf"));
      } else if (Gdx.files.absolute("/system/fonts/NotoSansHant-Regular.otf").exists()) {
        TCFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansHant-Regular.otf"));
      }

      // Japaneses font generators
      if (Gdx.files.absolute("/system/fonts/NotoSansJP-Regular.otf").exists()) {
        JPFontGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/NotoSansJP-Regular.otf"));
      }
      ...
      if (Gdx.files.absolute("/system/fonts/DroidSansFallback.ttf").exists()) {
        fallbackGenerator =
            new FreeTypeFontGenerator(Gdx.files.absolute("/system/fonts/DroidSansFallback.ttf"));
      } else {
    ...
    if (!systemfont) {
      ...
      KRFontGenerator =
          SCFontGenerator =
              TCFontGenerator =
                  JPFontGenerator =
                      new FreeTypeFontGenerator(Gdx.files.internal("fonts/fusion_pixel.ttf"));
    }
  ...
  private static Matcher CNMatcher =
      Pattern.compile(
  ...
  private static Pattern android6KRSplitter =
      Pattern.compile(
          "(?<= )|(?= )|(?<=\n)|(?=\n)|(?<=_)|(?=_)|(?<=\\\\)|(?=\\\\)|"
