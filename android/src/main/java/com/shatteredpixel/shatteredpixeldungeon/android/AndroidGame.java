...
public class AndroidGame extends AndroidApplication {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (instance == null) {
      ...
      // this is the default prefs filename given to an android app (.xml is automatically added to
      // it)
    ...
    if (SPDSettings.landscape() != null) {
      instance.setRequestedOrientation(
          Boolean.TRUE.equals(SPDSettings.landscape())
