...
public class WndResurrect extends Window {
	...
	public WndResurrect( final Ankh ankh ) {
		...
		RenderedTextBlock message = PixelScene.renderTextBlock(Messages.get(this, Statistics.ankhToExit ?  "an_message" : hero.lanterfire  < 40 && Statistics.lanterfireactive ? "low_message" : "message"), 6 );
