...
public class WndSettings extends WndTabbed {
  ...
  public WndSettings() {
    ...
    add(
        new IconTab(Icons.get(Icons.DISPLAY)) {
          @Override
    ...
    add(
        new IconTab(Icons.get(Icons.PREFS)) {
          @Override
          protected void select(boolean value) {
            super.select(value);
    ...
    add(
        new IconTab(Icons.get(Icons.DATA)) {
          @Override
          protected void select(boolean value) {
            super.select(value);
    ...
    add(
        new IconTab(Icons.get(Icons.AUDIO)) {
          @Override
          protected void select(boolean value) {
            super.select(value);
    ...
    IconTab langsTab =
        new IconTab(Icons.get(Icons.LANGS)) {
          @Override
          protected void select(boolean value) {
            super.select(value);
    ...
    add(
        new IconTab(Icons.get(Icons.CHANGES)) {
          @Override
          protected void select(boolean value) {
            super.select(value);
    ...
    add(
        new IconTab(new CrossDiedSprites()) {
          @Override
          protected void select(boolean value) {
            super.select(value);
  ...
  private static class DisplayTab extends Component {
    ...
    protected void createChildren() {
      ...
      chkFullscreen =
          new CheckBox(Messages.get(this, "fullscreen")) {
            @Override
      ...
      if (isAndroid()) {
        ...
        btnOrientation =
            new RedButton(
                finalLandscape ? Messages.get(this, "portrait") : Messages.get(this, "landscape")) {
              @Override
              protected void onClick() {
    ...
    protected void layout() {
      ...
      if (width > 200) {
        ...
        optVisGrid.setRect(
            optBrightness.right() + GAP, optBrightness.top(), width / 2 - GAP / 2, SLIDER_HEIGHT);
        // optSplashScreen.setRect(optBrightness.left(), optBrightness.bottom(), width,
        // SLIDER_HEIGHT);
      } else {
  ...
  private static class UITab extends Component {
    ...
    protected void createChildren() {
      ...
      if (DeviceCompat.hasHardKeyboard()) {
        ...
        btnKeyBindings =
            new RedButton(Messages.get(this, "key_bindings")) {
              @Override
              protected void onClick() {
                super.onClick();
    ...
    protected void layout() {
      ...
      if (barDesc != null) {
        ...
        if (width > 200) {
          ...
          chkFlipTags.setRect(
              chkFlipToolbar.right() + GAP, chkFlipToolbar.top(), width / 2 - 1, BTN_HEIGHT);
        } else {
  ...
  private static class ExtendTab extends Component {
    ...
    protected void createChildren() {
      ...
      ClassUI =
          new CheckBox(Messages.get(this, "dark_ui")) {
            @Override
            protected void onClick() {
              super.onClick();
      ...
      optSplashScreen =
          new OptionSlider(
              Messages.get(this, "splash_screen"),
      ...
      optFPSLimit =
          new CheckBox(Messages.get(this, "fpsdisplay")) {
            @Override
            protected void onClick() {
              super.onClick();
      ...
      quickslots =
          new OptionSlider(
              Messages.get(this, "quickslots"),
              "" + Constants.MIN_QUICKSLOTS,
              "" + Constants.MAX_QUICKSLOTS,
              Constants.MIN_QUICKSLOTS,
              Constants.MAX_QUICKSLOTS) {
            @Override
            protected void onChange() {
  ...
  private static class HelpTab extends Component {
    ...
    protected void createChildren() {
      ...
      LockFing =
          new CheckBox(Messages.get(this, "helpsettings")) {
            @Override
            protected void onClick() {
              super.onClick();
  ...
  private static class DataTab extends Component {
    ...
    protected void createChildren() {
      ...
      chkNews =
          new CheckBox(Messages.get(this, "news")) {
            @Override
            protected void onClick() {
              super.onClick();
      ...
      if (!DeviceCompat.isDesktop()) {
        chkWifi =
            new CheckBox(Messages.get(this, "wifi")) {
              @Override
              protected void onClick() {
                super.onClick();
      ...
      chkFireBase =
          new CheckBox(Messages.get(this, "firebase")) {
            @Override
            protected void onClick() {
              super.onClick();
              if (checked()) {
  ...
  private static class AudioTab extends Component {
    ...
    protected void createChildren() {
      ...
      if (DeviceCompat.isiOS() && Messages.lang() == Languages.ENGLISH) {
        ...
        chkIgnoreSilent =
            new CheckBox(Messages.get(this, "ignore_silent")) {
              @Override
              protected void onClick() {
                super.onClick();
    ...
    protected void layout() {
      ...
      if (width > 200) {
        ...
        chkMuteSFX.setRect(
            chkMusicMute.right() + 2, optSFX.bottom() + GAP, width / 2 - 1, BTN_HEIGHT);
  ...
  private static class LangsTab extends Component {
    ...
    protected void createChildren() {
      ...
      for (int i = 0; i < langs.size(); i++) {
        ...
        RedButton btn =
            new RedButton(Messages.titleCase(langs.get(i).nativeName()), 8) {
              @Override
              protected void onClick() {
                super.onClick();
      ...
      if (currLang != Languages.CHINESE) {
        ...
        btnCredits =
            new RedButton(credText, credText.length() > 9 ? 6 : 9) {
              @Override
              protected void onClick() {
                super.onClick();
                String creds = "";
                ...
                boolean wide =
                    (2 * reviewers.length + translators.length)
                        > (PixelScene.landscape() ? 15 : 30);
