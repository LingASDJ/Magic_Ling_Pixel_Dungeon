  ...
  public WndAutoShop() {
    ...
    RenderedTextBlock message =
        PixelScene.renderTextBlock(
            (Messages.get(WndAutoShop.class, "xwelcome"))
                + 200 * (Dungeon.depth / 5)
                + (Messages.get(WndAutoShop.class, "gold")),
            6);
  ...
  private class RewardWindow extends WndInfoItem {
    ...
    public RewardWindow(Item item) {
      ...
      RedButton btnConfirm =
          new RedButton(Messages.get(WndAutoShop.class, "buy")) {
            @Override
      ...
      RedButton btnCancel =
          new RedButton(Messages.get(WndAutoShop.class, "cancel")) {
            @Override
            protected void onClick() {
              hide();
            }
