...
public class WndRedDragon extends Window {
  ...
  public WndRedDragon(final RedDragon reddragon, final int type) {
    ...
    RewardButton btnFood =
        new RewardButton(randomArtifact() != null ? RedDragon.Quest.armor : RedDragon.Quest.RingT);
  ...
  private class RewardWindow extends WndInfoItem {
    ...
    public RewardWindow(Item item) {
      ...
      RedButton btnConfirm =
          new RedButton(Messages.get(WndRedDragon.class, "confirm")) {
            @Override
            protected void onClick() {
      ...
      RedButton btnCancel =
          new RedButton(Messages.get(WndSadGhost.class, "cancel")) {
            @Override
            protected void onClick() {
              RewardWindow.this.hide();
            }
