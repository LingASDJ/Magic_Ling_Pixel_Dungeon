...
public class Dungeon {
  ...
  // could all be their own separate numbers, but this allows iterating, much nicer for
  // bundling/initializing.
  ...
  public static void init() {
    ...
    seed =
        str.equals("")
            ...
            : SeedUtil.directConvert(str, 'A', 26); // DungeonSeed.randomSeed();
  ...
  public static boolean posNeeded() {
    ...
    // pos drops every two floors, (numbers 1-2, and 3-4) with a 50% chance for the earlier one each
    // time.
  ...
  public static void observe(int dist) {
    ...
    for (TalismanOfForesight.CharAwareness c :
        hero.buffs(TalismanOfForesight.CharAwareness.class)) {
    ...
    for (TalismanOfForesight.HeapAwareness h :
        hero.buffs(TalismanOfForesight.HeapAwareness.class)) {
  ...
  private static void setupPassable() {
    ...
    else BArray.setFalse(passable);
  }

  public static PathFinder.Path findPath(
      Char ch, int to, boolean[] pass, boolean[] vis, boolean chars) {
