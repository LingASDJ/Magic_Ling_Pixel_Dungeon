...
public class ItemSpriteSheet {
  ...
  static {
    for (int i = TIPPED_DARTS; i < TIPPED_DARTS + 16; i++) assignItemRect(i, 15, 15);
  }
  ...
  static {
    for (int i = WANDS; i < WANDS + 16; i++) assignItemRect(i, 14, 14);
  }
  ...
  static {
    for (int i = RINGS; i < RINGS + 16; i++) assignItemRect(i, 8, 10);
  }
  ...
  static {
    for (int i = SCROLLS; i < SCROLLS + 16; i++) assignItemRect(i, 15, 14);
  ...
  public static final int EXOTIC_RAIDO = EXOTIC_POTIONS + 5;
  ...
  static {
    for (int i = EXOTIC_POTIONS; i < EXOTIC_POTIONS + 16; i++) assignItemRect(i, 12, 13);
  }
  ...
  static {
    for (int i = STONES; i < STONES + 16; i++) assignItemRect(i, 14, 12);
  }
  ...
  static {
    for (int i = POTIONS; i < POTIONS + 16; i++) assignItemRect(i, 12, 14);
  ...
  static {
    for (int i = SEEDS; i < SEEDS + 16; i++) assignItemRect(i, 10, 10);
  }
  ...
  static {
    for (int i = BREWS; i < BREWS + 16; i++) assignItemRect(i, 12, 14);
  }
