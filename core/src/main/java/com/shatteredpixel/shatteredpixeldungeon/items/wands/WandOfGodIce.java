...
public class WandOfGodIce extends DamageWand {
    ...
    public int max(int lvl){
        return (10*lvl/2+6) * chargesPerCast();
    }
...
//            }
    ...
    private void affectMap(Ballistica beam){
        ...
        for (int c : beam.subPath(0, beam.dist)){
            ...
            //CellEmitter.center(c).burst(SnowParticle.FACTORY, Random.IntRange( 12, 25 ) );
    ...
    public String desc() {
        ...
        if(isIdentified()){
            desc = Messages.get(this, "desc", 2+level());
        } else {
            desc = Messages.get(this, "normal_desc",2);
        }
