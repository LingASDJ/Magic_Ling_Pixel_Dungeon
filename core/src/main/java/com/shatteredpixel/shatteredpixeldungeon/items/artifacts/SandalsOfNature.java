...
public class SandalsOfNature extends Artifact {
  ...
  public String desc() {
    ...
    if (isEquipped(Dungeon.hero)) {
      ...
      if (!cursed) desc += Messages.get(this, "desc_hint");
      else desc += Messages.get(this, "desc_cursed");
  ...
  public void restoreFromBundle(Bundle bundle) {
    ...
    if (bundle.contains(SEEDS)) Collections.addAll(seeds, bundle.getClassArray(SEEDS));
