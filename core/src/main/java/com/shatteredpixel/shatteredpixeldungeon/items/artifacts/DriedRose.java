...
public class DriedRose extends Artifact {
  ...
  public static class GhostHero extends DirectableAlly {
    ...
    public void damage(int dmg, Object src) {
      ...
      if (rose != null
          && rose.armor != null
          && rose.armor.hasGlyph(AntiMagic.class, this)
      ...
      if (c == Dungeon.hero && rose != null && !rose.talkedTo) {
        ...
        Game.runOnRenderThread(
            new Callback() {
              ...
              public void call() {
                GameScene.show(
                    new WndQuest(GhostHero.this, Messages.get(GhostHero.this, "introduce")));
              }
            });
        return true;
      } else {
  ...
  private static class WndGhostHero extends Window {
    ...
    WndGhostHero(final DriedRose rose) {
      ...
      btnWeapon.setRect(
          ...
          message.top() + message.height() + GAP,
          BTN_SIZE,
          BTN_SIZE);
      if (rose.weapon != null) {
