...
public class BrokenRingRingBind extends Ring {

    public Ring bound;   // 被束缚的真戒指（本体存在这里）

    // 束缚真戒指时调用：先存本体引用，再抄图标
    public void mimic(Ring original) {
        bound = original;
