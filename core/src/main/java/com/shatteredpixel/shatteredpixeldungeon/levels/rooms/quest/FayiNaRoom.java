...
public class FayiNaRoom extends SpecialRoom {
    ...
    public void paint(Level level) {
        ...
        if (door.x == left || door.x == right){
            ...
            while (firePos.y != bottom){
                Blob.seed(level.pointToCell(firePos), 1, com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.MagicalFireRoom.EternalFire.class, level);
        ...
        Mob mob = new ClearElemtGuard();
        mob.pos = pos;
        level.drop( new Food(), pos);
        level.mobs.add(mob);
    ...
    public boolean canPlaceCharacter(Point p, Level l) {
        Blob fire = l.blobs.get(com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.MagicalFireRoom.EternalFire.class);
