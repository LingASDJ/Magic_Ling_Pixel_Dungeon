...
public class CrystalTwoRoom extends CustomLuaRoom {
    {
        width = 17;
        height = 17;
        map_lua_file = Assets.Map_Luas.CryStalThreeRoom_MapLua;
    }
    ...
    public void paint(Level level) {
        ...
        int c = (top + 9) * level.width() + left + 6;
        level.drop(HighChestRules(), c).type = Heap.Type.CRYSTAL_CHEST;

        int is = (top + 5) * level.width() + left + 10;
