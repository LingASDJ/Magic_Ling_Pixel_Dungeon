...
public class CrystalThreeRoom extends CustomLuaRoom {
    {
        width = 13;
        height = 13;
        map_lua_file = Assets.Map_Luas.CryStalTwoRoom_MapLua;
    }
    ...
    public void paint(Level level) {
        ...
        int c = (top + 3) * level.width() + left + 6;
        level.drop(HighChestRules(), c).type = Heap.Type.CRYSTAL_CHEST;

        int is = (top + 3) * level.width() + left + 5;
