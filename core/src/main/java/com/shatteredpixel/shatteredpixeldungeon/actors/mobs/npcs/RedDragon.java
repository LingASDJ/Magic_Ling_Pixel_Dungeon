    ...
    if (Quest.given) {
                ...
                public void call() {
                  switch (Quest.type) {
                    ...
                    default:
                      GameScene.show(
                          new WndQuest(
                              RedDragon.this, Messages.get(RedDragon.this, "gnollshiled_2")));
                      break;
                    case 2:
                      GameScene.show(
                          new WndQuest(
                              RedDragon.this, Messages.get(RedDragon.this, "skullshaman_2")));
                      break;
                    case 3:
                      GameScene.show(
                          new WndQuest(RedDragon.this, Messages.get(RedDragon.this, "flamec01_2")));
                      break;
                  }
                }
              });
      ...
      switch (Quest.type) {
        ...
        default:
          ...
          txt_quest = Messages.get(this, "gnollshiled_1", hero.name());
          break;
        case 2:
    ...
    public static void spawn(CavesLevel level) {
      if (!spawned && Dungeon.depth > 11 && Random.Int(15 - Dungeon.depth) == 0) {
        ...
        switch (Random.chances(new float[] {0, 0, 10, 6, 3, 1})) {
          default:
          case 2:
            food = new BlizzardBrew();
            break;
          case 3:
            food = new CausticBrew();
            break;
          case 4:
            food = new InfernalBrew();
            break;
          case 5:
            food = new ShockingBrew();
            break;
        }
        ...
        if (item != null) {
          switch (Random.Int(6)) {
            case 1:
              armor = new CapeOfThorns();
              break;
            case 2:
              armor = new AlchemistsToolkit();
              break;
            case 3:
              armor = new ChaliceOfBlood();
              break;
            case 4:
              armor = new DriedRose();
              break;
            case 5:
              armor = new SandalsOfNature();
              break;
            case 6:
              armor = new TimekeepersHourglass();
              break;
          }
        } else {
          switch (Random.chances(new float[] {0, 0, 10, 6, 3, 1})) {
