...
public class Bestiary {
  ...
  private static ArrayList<Class<? extends Mob>> standardMobRotation(int i) {
      ...
      switch (i) {
        ...
        case 15:
          switch (Random.Int(4)) {
            ...
            case 3:
              return new ArrayList<>(
                  Arrays.asList(Elemental.random(), Monk.class, Monk.class, Golem.class));
          }
        case 16:
        case 17:
        case 18:
        ...
        default:
          return new ArrayList<>(
              Arrays.asList(
                  Rat.class, Rat.class, Rat.class, Rat.class, Rat.class, Rat.class, Rat.class,
    ...
    switch (i) {
      ...
      case 5:
        return new ArrayList<>(
            Arrays.asList(Rat.class, Rat.class, Slime.class, Slime.class, Swarm.class, Crab.class));
      case 6:
        return new ArrayList<>(
            Arrays.asList(
                Skeleton.class,
      ...
      case 7:
        return new ArrayList<>(
            Arrays.asList(
                Skeleton.class, BlackHost.class, Thief.class, DM100.class, Necromancer.class));
      case 8:
        return new ArrayList<>(
            Arrays.asList(
                Skeleton.class,
      ...
      case 10:
        return new ArrayList<>(
            Arrays.asList(
                Bat.class, Brute.class, Brute.class, Necromancer.class, Necromancer.class));
      case 11:
        return new ArrayList<>(
            Arrays.asList(
                Bat.class, DM100.class, DM100.class, ColdMagicRat.class, ColdMagicRat.class));
      case 12:
        // 1x bat, 1x brute, 2x shaman, 2x spinner, 2x DM-300
        return new ArrayList<>(
            Arrays.asList(Bat.class, ColdMagicRat.class, FireGhost.class, ColdMagicRat.class));
      case 13:
        // 1x bat, 1x brute, 2x shaman, 2x spinner, 2x DM-300
        return new ArrayList<>(
            Arrays.asList(Bat.class, Brute.class, Spinner.class, DM100.class, RedSwarm.class));

      case 14:
        return new ArrayList<>(
            Arrays.asList(Bat.class, Spinner.class, ColdMagicRat.class, RedSwarm.class));
      case 15:
        // 1x bat, 1x brute, 2x shaman, 2x spinner, 2x DM-300
        return new ArrayList<>(
            Arrays.asList(
      ...
      case 18:
        ...
        return new ArrayList<>(
            Arrays.asList(
                Elemental.random(), Warlock.class, Monk.class, Golem.class, FireGhost.class));
      case 19:
        // 1x elemental, 1x warlock, 2x monk, 3x golem
        return new ArrayList<>(
            Arrays.asList(
      ...
      case 23:
        ...
        return new ArrayList<>(
            Arrays.asList(
                Succubus.class, Eye.class, Scorpio.class, Succubus.class, ShieldHuntsman.class));
        // 前半段决战
      case 24:
        // 1x succubus, 2x evil eye, 3x scorpio
        return new ArrayList<>(
