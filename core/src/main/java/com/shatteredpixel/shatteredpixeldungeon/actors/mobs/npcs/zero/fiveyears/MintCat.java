...
import com.shatteredpixel.shatteredpixeldungeon.custom.utils.plot.MintPlot;
...
public class MintCat extends NTNPC {
    ...
    public boolean interact(Char c) {
        ...
        if (first) {
            ...
            MintPlot.NewYearsPlot plot = new MintPlot.NewYearsPlot();
