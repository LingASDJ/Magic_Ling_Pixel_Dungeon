...
public class FireMagicDied extends Mob implements Callback {
  ...
  protected static boolean isSummonedByDK(Mob m) {
    return (m instanceof FireMagicDied.ColdGuradA
        || m instanceof FireMagicDied.ColdGuradB
        || m instanceof FireMagicDied.ColdGuradC);
  }
    ...
    if (phase == 1) {
      ...
      switch (Random.Int(7)) {
        ...
        case 2:
          ...
          break;
        case 3:
          Buff.affect(this, ChampionEnemy.Giant.class);
          break;
        case 4:
          Buff.affect(this, ChampionEnemy.Blessed.class);
          break;
        case 5:
  ...
  public void die(Object cause) {
    ...
    for (Mob mob : Dungeon.level.mobs.toArray(new Mob[0])) {
      if (mob instanceof FireMagicDied.ColdGuradA
          || mob instanceof SRPDICLRPRO
          || mob instanceof Skeleton
          || mob instanceof DM100
          || mob instanceof BlackHost
          || mob instanceof Warlock
          || mob instanceof Monk
          || mob instanceof CrystalDiedTower) {
        mob.die(cause);
      }
    }
