...
public class IceCrystal extends Mob {

    {
        spriteClass = IceCryStalSprite.class;
    ...
    public boolean spawnRecordedIce = false;

    @Override
    protected boolean act() {
        if (!spawnRecordedIce){
            Statistics.spawnersIce++;
            spawnRecordedIce = true;
        }
        ...
        if (spawnCooldown <= 0){
            ...
            if (!candidates.isEmpty()) {
                ...
                if (Dungeon.depth > 11){
                    ...
                    spawnCooldown -= Math.min(10, (Dungeon.depth-11)*6.67);
                }
            }
        }
        return super.act();
    ...
    public void storeInBundle(Bundle bundle) {
        ...
        bundle.put(SPAWN_RECORDED, spawnRecordedIce);
    }
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        spawnRecordedIce = bundle.getBoolean(SPAWN_RECORDED);
    }
