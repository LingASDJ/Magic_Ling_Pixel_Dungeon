...
public abstract class Char extends Actor {
	...
	protected static final String VENOMDAMAGE	    = "venomdamage";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( VENOMDAMAGE, venodamage );
	}
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		venodamage = bundle.getInt( VENOMDAMAGE );
...
//		return acuRoll * accMulti) >= defRoll;
	...
	public void damage( int dmg, Object src, DamageType type ) {
		...
		if (!isAlive()) {
			die( src );
		} else if (HP == 0 && buff(DeadBomb.TargetDead.class) != null){
	...
	public boolean TrueDied = false;

	public boolean isAlive() {
		return HP > 0 || deathMarked || TrueDied;
	}
	...
	public boolean isInvulnerable( Class effect ){
		return buff(Challenge.SpectatorFreeze.class) != null || buff(Invulnerability.class) != null || buff(RoseShiled.class) != null || buff(TimeStasis.class) != null;
	}
