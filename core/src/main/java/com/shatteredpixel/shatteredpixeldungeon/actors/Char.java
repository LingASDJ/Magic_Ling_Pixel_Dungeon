...
public abstract class Char extends Actor {
    ...
    if (Dungeon.level.adjacent(pos, c.pos)) {
      return true;
        ...
        && Dungeon.level.distance(pos, c.pos)
            <= 2 * Dungeon.hero.pointsInTalent(Talent.ALLY_WARP)) {
      return true;
    } else {
      return false;
    }
  ...
  public boolean interact(Char c) {
    ...
    if (c == Dungeon.hero && Dungeon.hero.hasTalent(Talent.ALLY_WARP)) {
      PathFinder.buildDistanceMap(
          c.pos, BArray.or(Dungeon.level.passable, Dungeon.level.avoid, null));
    ...
    if (enemy.isInvulnerable(getClass())) {
      ...
      if (enemy.isAlive() && enemy.alignment != alignment && prep != null && prep.canKO(enemy)) {
        ...
        enemy.sprite.showStatus(
            CharSprite.NEGATIVE, Messages.get(Preparation.class, "assassinated"));
      }
  ...
  public void damage(int dmg, Object src) {
    ...
    int shielded = dmg;
    // FIXME: when I add proper damage properties, should add an IGNORES_SHIELDS property to use
    // here.
    ...
    if (sprite != null) {
      sprite.showStatus(
          HP > HT / 2 ? CharSprite.WARNING : CharSprite.NEGATIVE, Integer.toString(dmg + shielded));
    }
  ...
  public void move(int step, boolean travelling) {
    ...
    if (travelling && Dungeon.level.adjacent(step, pos) && buff(Vertigo.class) != null) {
      ...
      if (!(Dungeon.level.passable[newPos] || Dungeon.level.avoid[newPos])
          ...
          || Actor.findChar(newPos) != null) return;
      else {
  ...
  public HashSet<Property> properties() {
    ...
    // TODO any more of these and we should make it a property of the buff, like with
  ...
  public enum Property {
    BOSS(
        new HashSet<Class>(
            Arrays.asList(
                Grim.class, GrimTrap.class, ScrollOfRetribution.class, ScrollOfPsionicBlast.class)),
        new HashSet<Class>(Arrays.asList(AllyBuff.class, Dread.class))),
    MINIBOSS(new HashSet<Class>(), new HashSet<Class>(Arrays.asList(AllyBuff.class, Dread.class))),
    NOBIG(new HashSet<Class>(), new HashSet<Class>(Arrays.asList(HaloFireImBlue.class))),
    UNDEAD,
    DEMONIC,
    INORGANIC(
        new HashSet<Class>(),
    ...
    FIERY(
        new HashSet<Class>(Arrays.asList(WandOfFireblast.class, Elemental.FireElemental.class)),
        new HashSet<Class>(Arrays.asList(Burning.class, Blazing.class))),
    ICY(
        new HashSet<Class>(Arrays.asList(WandOfFrost.class, Elemental.FrostElemental.class)),
        new HashSet<Class>(Arrays.asList(Frost.class, Chill.class))),
    ACIDIC(
        new HashSet<Class>(Arrays.asList(Corrosion.class)),
