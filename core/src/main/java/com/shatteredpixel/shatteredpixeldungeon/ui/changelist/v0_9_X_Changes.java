...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CHANGES), "New Challenge!",
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.CHANGES), "Hostile Champions",
	...
	public static void add_v0_9_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.CHANGES), "Existing Challenges",
