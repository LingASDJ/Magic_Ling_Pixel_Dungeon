...
public class vM0_5_X_Changes {
    ...
    public static void add_v0_6_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.STAIRS), (Messages.get(vM0_5_X_Changes.class, "dev9")),
    ...
    public static void add_v0_5_5_Changes( ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.STAIRS), (Messages.get(vM0_5_X_Changes.class, "dev6")),
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.SLEEP), (Messages.get(vM0_5_X_Changes.class, "kotlinss")),
    ...
    public static void add_v0_5_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.STAIRS), (Messages.get(vM0_5_X_Changes.class, "dev5")),
