      ...
      case 2:
        ...
        result.add(
            new QuickRecipe(
                new MeatPie.Recipe(),
                new ArrayList<Item>(
                    Arrays.asList(new Pasty(), new Food(), new MysteryMeat.PlaceHolder())),
                new MeatPie()));
        result.add(
            new QuickRecipe(
                new LightFood.Recipe(),
                new ArrayList<Item>(
                    Arrays.asList(new AikeLaier.Seed(), new Food(), new FrozenCarpaccio())),
                new LightFood()));
        result.add(
            new QuickRecipe(
        ...
        result.add(
            new QuickRecipe(
                ...
                new ArrayList<Item>(
                    Arrays.asList(
                        new FrozenCarpaccio(), new MagicalInfusion(), new AlchemicalCatalyst())),
                new IceFishSword()));
        result.add(null);
        result.add(
            new QuickRecipe(
      ...
      case 3:
        ...
        result.add(
            new QuickRecipe(
                ...
                new ArrayList<Item>(
                    Arrays.asList(
                        new PotionOfPurity(), new AlchemicalCatalyst(), new StoneOfBlink())),
        ...
        result.add(
            new QuickRecipe(
                ...
                new ArrayList<Item>(
                    Arrays.asList(
                        new PotionOfLiquidFlameX(), new ScrollOfFlameCursed(), new Stylus())),
                new WandOfBlueFuck()));
        return result;
      case 4:
      ...
      case 7:
        result.add(
            new QuickRecipe(
                ...
                new ArrayList<>(
                    Arrays.asList(new Potion.PlaceHolder(), new Plant.Seed.PlaceHolder())),
                new AlchemicalCatalyst()));
        result.add(
            new QuickRecipe(
                new AlchemicalCatalyst.Recipe(),
                new ArrayList<>(
                    Arrays.asList(new Potion.PlaceHolder(), new Runestone.PlaceHolder())),
                new AlchemicalCatalyst()));
        result.add(null);
        result.add(null);
        result.add(
            new QuickRecipe(
                ...
                new ArrayList<>(
                    Arrays.asList(new Scroll.PlaceHolder(), new Runestone.PlaceHolder())),
                new ArcaneCatalyst()));
        result.add(
            new QuickRecipe(
                new ArcaneCatalyst.Recipe(),
                new ArrayList<>(
                    Arrays.asList(new Scroll.PlaceHolder(), new Plant.Seed.PlaceHolder())),
                new ArcaneCatalyst()));
        return result;
      case 8:
