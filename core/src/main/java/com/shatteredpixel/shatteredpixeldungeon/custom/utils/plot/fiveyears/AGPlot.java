...
public class AGPlot extends Plot {
    ...
    private void process_to_1() {
        ...
        hero.interrupt();
        diagulewindow.setLeftName(Messages.get(AG.class, "name"));
        diagulewindow.changeText(Messages.get(AG.class, "messages1"));
    }

    private void process_to_2() {
        diagulewindow.changeText(Messages.get(AG.class, "messages2"));
    }

    private void process_to_3() {
        diagulewindow.changeText(Messages.get(AG.class, "messages3"));
        DropRules();
        skipGetItems = true;
    }
