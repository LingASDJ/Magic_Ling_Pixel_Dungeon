...
public class IceMagicGirlPlot extends Plot {
    ...
    private void process_to_2() {
        diagulewindow.changeText(Messages.get(IceMagicGirl.class, "messages2"));
    }

    private void process_to_3() {
        diagulewindow.changeText(Messages.get(IceMagicGirl.class, "messages3",hero.name()));
    }

    private void process_to_4() {
        diagulewindow.changeText(Messages.get(IceMagicGirl.class, "messages4"));
        DropRules();
        skipGetItems = true;
    }
    ...
    private void DropRules(){
        Dungeon.level.drop(new PotionOfFrost().identify(), hero.pos).sprite.drop();
    }
