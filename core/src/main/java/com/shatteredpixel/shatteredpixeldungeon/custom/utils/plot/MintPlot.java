...
//                    break;
    ...
    public static class NewYearsPlot extends Plot {
        ...
        private void process_to_2() {
            diagulewindow.changeText(Messages.get(Mint.class, "message2_ny",hero.name()));
        }

        private void process_to_3() {
            skipGetItems = true;
            diagulewindow.changeText(Messages.get(Mint.class, "message3_ny",hero.name()));
